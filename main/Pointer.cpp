...
void Pointer::begin(int az_1,int az_3,int az_2,int az_4,int8_t to_east,int al_1,int al_3,int al_2,int al_4,int8_t to_zenith){
...
void Pointer::setAltitude(float rad){
  _al->moveTo(toZ*(long)toSteps(rad));
}

void Pointer::setAzimuth(float rad){
  _az->moveTo(toE*(long)toSteps(rad));
}
